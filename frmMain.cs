    ...
    public partial class frmMain : Form
    {
        ...
        private void frmMain_Load(object sender, EventArgs e)
        {
            ...
            if (conSQL)                                                     //проверить соединение с базами
            {
                ...
                InitializeListView();
                LoadListUser(clMsSqlDatabase.TableRequest(cs, "select * from twt_GetPassFormDate('" + mcRegDate.SelectionStart.ToString("yyyyMMdd") + "', '" + mcRegDate.SelectionStart.ToString("yyyyMMdd") + "', '') order by fio"));
...
//                                    ,MessageBoxOptions.ServiceNotification //.DefaultDesktopOnly
 ...
 //               LoadListUser(clMsSqlDatabase.TableRequest(cs, "select * from twt_GetPassFormDate('" + keyDate + "','') order by fio"));
                LoadListUser(clMsSqlDatabase.TableRequest(cs, "select * from twt_GetPassFormDate('" + keyDate + "', '" + keyDate + "', '') order by fio"));
